...
public class setRejectRequestService extends AsyncTask<String, Void,  String> {
    Context context;


    public setRejectRequestService(Context ctx){
    ...
    protected  String doInBackground(String... params) {
        ...
        String url_string = baseUrl+"/Neighbour/public/setRejectRequest";
