...
public class setDeActiveServiceMan extends AsyncTask<String, Void,  String> {
    Context context;


    public setDeActiveServiceMan(Context ctx){
    ...
    protected  String doInBackground(String... params) {
        ...
        String url_string = baseUrl+"/Neighbour/public/setEmployeeStausDeActive";
