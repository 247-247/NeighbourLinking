...
public class setDeActiveBrand extends AsyncTask<String, Void,  String> {
    Context context;


    public setDeActiveBrand(Context ctx){
    ...
    protected  String doInBackground(String... params) {
        ...
        if(AppStatus.getInstance(context).isOnline()) {
            String url_string = baseUrl + "/Neighbour/public/setBrandStausDeActive";
