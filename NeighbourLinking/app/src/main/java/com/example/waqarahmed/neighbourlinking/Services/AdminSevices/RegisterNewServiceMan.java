...
public class RegisterNewServiceMan extends AsyncTask<String, Void, String> {

    Context cxt;
    ProgressDialog progress ;

    public RegisterNewServiceMan(Context context) {
        cxt=context;
    }
        ...
        super.onPostExecute(s);
            ...
            if(s.equals("yes")){
               // Toast.makeText(cxt,"True",Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(cxt,"User Already exist",Toast.LENGTH_SHORT).show();
